...
func newBranch(db *gorm.DB, opts ...gen.DOOption) branch {
	...
	_branch.BranchID = field.NewInt64(tableName, "branch_id")
	_branch.RepoID = field.NewInt64(tableName, "repo_id")
	_branch.BranchName = field.NewString(tableName, "branch_name")
	_branch.HeadSnapshotID = field.NewInt64(tableName, "head_snapshot_id")
...
func (b *branch) updateTableName(table string) *branch {
	...
	b.RepoID = field.NewInt64(table, "repo_id")
	b.BranchName = field.NewString(table, "branch_name")
	b.HeadSnapshotID = field.NewInt64(table, "head_snapshot_id")
...
func (b *branch) fillFieldMap() {
	...
	b.fieldMap["repo_id"] = b.RepoID
	b.fieldMap["branch_name"] = b.BranchName
	b.fieldMap["head_snapshot_id"] = b.HeadSnapshotID
}
