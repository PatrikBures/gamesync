...
func newPermission(db *gorm.DB, opts ...gen.DOOption) permission {
	...
	_permission.PermID = field.NewInt32(tableName, "perm_id")
	_permission.PermName = field.NewString(tableName, "perm_name")
...
func (p *permission) updateTableName(table string) *permission {
	...
	p.PermID = field.NewInt32(table, "perm_id")
	p.PermName = field.NewString(table, "perm_name")
...
func (p *permission) fillFieldMap() {
	...
	p.fieldMap["perm_id"] = p.PermID
	p.fieldMap["perm_name"] = p.PermName
}
