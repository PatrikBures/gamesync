...
func newRepo(db *gorm.DB, opts ...gen.DOOption) repo {
	...
	_repo.RepoID = field.NewInt64(tableName, "repo_id")
	_repo.UserID = field.NewInt64(tableName, "user_id")
...
func (r *repo) updateTableName(table string) *repo {
	...
	r.RepoID = field.NewInt64(table, "repo_id")
...
func (r *repo) WithContext(ctx context.Context) IRepoDo { return r.repoDo.WithContext(ctx) }

func (r repo) TableName() string { return r.repoDo.TableName() }

func (r repo) Alias() string { return r.repoDo.Alias() }

func (r repo) Columns(cols ...field.Expr) gen.Columns { return r.repoDo.Columns(cols...) }
