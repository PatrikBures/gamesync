...
func newRolePermission(db *gorm.DB, opts ...gen.DOOption) rolePermission {
	...
	_rolePermission.RolePermID = field.NewInt32(tableName, "role_perm_id")
	_rolePermission.RoleID = field.NewInt32(tableName, "role_id")
	_rolePermission.PermID = field.NewInt32(tableName, "perm_id")
...
func (r *rolePermission) updateTableName(table string) *rolePermission {
	...
	r.RolePermID = field.NewInt32(table, "role_perm_id")
	r.RoleID = field.NewInt32(table, "role_id")
	r.PermID = field.NewInt32(table, "perm_id")
...
func (r *rolePermission) fillFieldMap() {
	...
	r.fieldMap["role_perm_id"] = r.RolePermID
