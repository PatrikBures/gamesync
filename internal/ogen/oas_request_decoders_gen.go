...
func (s *Server) decodePutBranchRequest(r *http.Request) (
	req *SnapshotID,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodePutChunkRequest(r *http.Request) (
	req PutChunkReq,
	rawBody []byte,
	close func() error,
	rerr error,
	...
	case ct == "application/octet-stream":
		reader := r.Body
		request := PutChunkReq{Data: reader}
		return request, rawBody, close, nil
	default:
		return req, rawBody, close, validate.InvalidContentType(ct)
	}
