...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		case '/': // Prefix: "/"
			...
			switch elem[0] {
			case 'c': // Prefix: "chunks/"

				if l := len("chunks/"); len(elem) >= l && elem[0:l] == "chunks/" {
					elem = elem[l:]
				} else {
					break
				}
			...
			case 'p': // Prefix: "perms"
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "GET":
						s.handleGetPermsRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, notAllowedParams{
							allowedMethods: "GET",
								...
								case '/': // Prefix: "/"
									...
									case 's': // Prefix: "snapshots/"
										...
										if len(elem) == 0 {
											switch r.Method {
											case "DELETE":
												s.handleDeleteSnapshotRequest([3]string{
													args[0],
													args[1],
													args[2],
												}, elemIsEscaped, w, r)
		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Get health of server"
						r.operationID = "get-health"
						r.operationGroup = ""
			...
			case 'p': // Prefix: "perms"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "GET":
						r.name = GetPermsOperation
						r.summary = "Get all available permissions"
						r.operationID = "get-perms"
						r.operationGroup = ""
						r.pathPattern = "/perms"
						r.args = args
						r.count = 0
			...
			case 'r': // Prefix: "roles"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Get all roles"
						r.operationID = "get-roles"
						r.operationGroup = ""
						r.pathPattern = "/roles"
						r.args = args
						r.count = 0
						return r, true
					case "POST":
						r.name = PostRolesOperation
						r.summary = "Create new role"
						r.operationID = "post-roles"
						r.operationGroup = ""
						r.pathPattern = "/roles"
						r.args = args
						r.count = 0
			...
			case 'u': // Prefix: "users"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						return r, true
					case "POST":
						r.name = PostUsersOperation
						r.summary = "Create new user"
						r.operationID = "post-users"
						r.operationGroup = ""
						r.pathPattern = "/users"
						r.args = args
						r.count = 0
					...
					case 'm': // Prefix: "me"
						...
						if len(elem) == 0 {
							...
							case "GET":
								...
								r.summary = "Get id of the token bearer"
								r.operationID = "get-me"
								r.operationGroup = ""
									...
									case 's': // Prefix: "snapshots/"
										...
										if len(elem) == 0 {
											...
											case "DELETE":
												...
												r.operationGroup = ""
												r.pathPattern = "/users/{userID}/repos/{repoName}/snapshots/{snapshotID}"
												r.args = args
												r.count = 3
												return r, true
											default:
