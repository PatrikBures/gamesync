...
// DeleteBranchParams is parameters of delete-branch operation.
...
func decodeDeleteBranchParams(args [3]string, argsEscaped bool, r *http.Request) (params DeleteBranchParams, _ error) {
	// Decode path: userID.
	if err := func() error {
		param := args[0]
		if argsEscaped {
...
func unpackGetSnapshotAncestorParams(packed middleware.Parameters) (params GetSnapshotAncestorParams) {
	{
		...
		params.TargetSnapshotID = packed[key].(int64)
	}
	{
		key := middleware.ParameterKey{
			Name: "userID",
		...
		if err := q.HasParam(cfg); err == nil {
			...
			if err := func() error {
				if err := (validate.Int{
					...
					MultipleOf:    0,
					Pattern:       nil,
				}).Validate(int64(params.TargetSnapshotID)); err != nil {
					return errors.Wrap(err, "int")
				}
				return nil
			}(); err != nil {
